...
export PATH=$HOME/.local/bin:$HOME/miniconda3/bin:$HOME/bin:/usr/local/bin:$PATH
...
plugins=(git vi-mode conda-zsh-completion zsh-syntax-highlighting zsh-autosuggestions zsh-history-substring-search)
